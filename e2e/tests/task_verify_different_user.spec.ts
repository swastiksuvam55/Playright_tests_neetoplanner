...
test.describe("Verify different User", () => {
    ...
    test("should create a new project", async ({ loginPage, page, projectPage, differentTaskPage, verifyTaskPage }) => {
        ...
        await test.step("Step 1: Navigate to the sign-up page and login for standard user", async () => {
            ...
            await loginPage.loginAndVerifyUser({
                email: "cpts9gnqty9-planner-swastik_singh-iiit_bhubaneswar+standard@bigbinary.com",
            });
            ...
            await page.waitForURL('https://swastik-singh-standard.neetoplanner.net/dashboard/active');
        });
        ...
        await test.step("Step 3: Navigate to the sign-up page and login for", async () => {
            await page.goto("https://app.neetoauth.net/signups/new?redirect_uri=neetoplanner.net");
            await page.getByRole('link', { name: 'Log in' }).click();
            // await loginPage.loginAndVerifyUser({
