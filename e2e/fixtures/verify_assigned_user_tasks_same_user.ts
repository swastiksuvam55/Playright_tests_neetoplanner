...
export async function verifySameUser(page: Page) {
    ...
    await page.getByPlaceholder('Enter project name').fill(projectName1);// create first project
    ...
    await page.getByPlaceholder('Enter project name').click();
    await page.getByPlaceholder('Enter project name').fill(projectName2);//create second project
    await page.getByPlaceholder('Enter description').click();
